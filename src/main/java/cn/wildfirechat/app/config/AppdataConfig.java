...
@EnableJpaRepositories(
        ...
        basePackages= { "cn.wildfirechat.app.jpa" }) //设置Repository所在位置
public class AppdataConfig {

    @Autowired
    @Qualifier("appdataDataSource")
    private DataSource appdataDataSource;
    ...
    @Primary
    @Bean(name = "appdataEntityManager")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary (EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("cn.wildfirechat.app.jpa") //设置实体类所在位置
                .persistenceUnit("appdataPersistenceUnit")
